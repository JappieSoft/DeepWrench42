...
VALUES (now(), 'CHECK_OUT', 2, '516543', 'K03562141',  'TOOLKIT', 'A330 NLG Gland Nut kit',         2000, 'MAG003451',  'DL00158',      'Magema',   '3311', NULL),
       (now(), 'CHECK_IN',  1,  '523043', 'R0454545',   'TOOL',    'Metric Socket Set 6-24mm',       2811, 'AS28431',    'SS-987654321', 'Proto',    '3310', NULL),
       (now(), 'CHECK_OUT', 2, '516543', 'SPARK01',    'TOOL',    'Spark Plug Socket 16mm',         7325, 'T8438',      'SPS-112233445','Craft',    '8AB',  NULL),
       (now(), 'CHECK_OUT', 2, '509704', 'RR57698',    'TOOLKIT', 'XWB HMU AGB STUD Extractor Kit', 2796, 'P23499',     'FG-456789123', 'Starrett', '3527', 'calibration');
